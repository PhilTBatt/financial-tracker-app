...
This is the frontend app for my **Financial Tracker** application.  
The fullstack application allows users to upload transaction files, which are sent to a Java Spring Boot API and processed by a Python AWS Lambda function. This processed data is stored in DynamoDB and then retrieved via the API to display on the Angular app with Chart.js.
